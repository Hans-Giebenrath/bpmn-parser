...
pub fn defs() -> String {
  ...
  <symbol id="envelope-outline" viewBox="0 0 36 36" overflow="visible">
      <path
         ...
         />
      <path
         d="M 8,11.318781 18,17 28,11.318781"
         fill="none"
         stroke="inherit"
         style="stroke-width:1.7;stroke-linecap:round;stroke-linejoin:round;stroke-dasharray:none"
         />
  ...
  <symbol id="event-timer-catching" viewBox="0 0 36 36" overflow="visible">
  <circle
     fill="none"
     stroke="inherit"
  ...
  <g transform="translate(18,18)">
    ...
    fill="none"
    stroke="inherit"
       style="stroke-width:1.4;stroke-linecap:round;stroke-linejoin:round;stroke-dasharray:none"
       d="M 0,-10.691356 V -8.69135" />
    <path
    fill="none"
    stroke="inherit"
       style="stroke-width:1.4;stroke-linecap:round;stroke-linejoin:round;stroke-dasharray:none"
       d="M 0,8.6913502 V 10.691356" />
  </g>
  <g transform="rotate(90,0,18)">
    <path
    fill="none"
    stroke="inherit"
       style="stroke-width:1.4;stroke-linecap:round;stroke-linejoin:round;stroke-dasharray:none"
  ...
  <g transform="rotate(-2.66915,395.31681,-377.31681)">
    <g transform="rotate(-57.33085)">
      <path
      fill="none"
      stroke="inherit"
         style="stroke-width:1.4;stroke-linecap:round;stroke-linejoin:round;stroke-dasharray:none"
  ...
  <g transform="rotate(-2.117003,496.10687,-478.10687)">
    <g transform="rotate(-27.882997)">
      <path
      fill="none"
      stroke="inherit"
         style="stroke-width:1.4;stroke-linecap:round;stroke-linejoin:round;stroke-dasharray:none"
  ...
  <path
     fill="none" stroke="inherit" stroke-width="1.7"
     style="stroke-linecap:round;stroke-linejoin:round;stroke-dasharray:none"
     d="M 24,20 18,18 20.469175,9" />
  </symbol>

  <symbol id="event-error-catching" viewBox="0 0 36 36" overflow="visible">
  <path
     fill="none" stroke="inherit" stroke-width="1.7"
     style="stroke-linecap:round;stroke-linejoin:round"
     d="M 10,24 15.785421,9 20.214579,18 26,12 20.214579,27 15.785421,18 Z" />
  </symbol>

  <symbol id="event-error-throwing" viewBox="0 0 36 36" overflow="visible">
  <path
     fill="inherit" stroke="inherit" stroke-width="1.7"
     style="stroke-linecap:round;stroke-linejoin:round"
     d="M 10,24 15.785421,9 20.214579,18 26,12 20.214579,27 15.785421,18 Z" />
  </symbol>

  <symbol id="event-escalation-catching" viewBox="0 0 36 36" overflow="visible">
  <path
     fill="none" stroke="inherit" stroke-width="1.7"
     style="stroke-linecap:round;stroke-linejoin:round"
     d="m 18,8 -7,19 7,-7 7,7 z" />
  </symbol>

  <symbol id="event-escalation-throwing" viewBox="0 0 36 36" overflow="visible">
  <path
     fill="inherit" stroke="inherit" stroke-width="1.7"
     style="stroke-linecap:round;stroke-linejoin:round"
     d="m 18,8 -7,19 7,-7 7,7 z" />
  ...
  <symbol id="event-cancel-catching" viewBox="0 0 36 36" overflow="visible">
  <path
     fill="none" stroke="inherit" stroke-width="1.7"
     style="stroke-linecap:round;stroke-linejoin:round"
     d="m 24,9 3,3 -6,6 6,6 -3,3 -6,-6 -6,6 -3,-3 6,-6 -6,-6 3,-3 6,6 z"
     />
  </symbol>

  <symbol id="event-cancel-throwing" viewBox="0 0 36 36" overflow="visible">
  <path
     fill="inherit" stroke="inherit" stroke-width="1.7"
     style="stroke-linecap:round;stroke-linejoin:round"
     d="m 24,9 3,3 -6,6 6,6 -3,3 -6,-6 -6,6 -3,-3 6,-6 -6,-6 3,-3 6,6 z"
  ...
  <symbol id="event-compensation-catching" viewBox="0 0 36 36" overflow="visible">
  <path
     fill="none" stroke="inherit" stroke-width="1.7"
     style="stroke-linecap:round;stroke-linejoin:round"
     d="m 25.463694,10 v 16 l -9,-8 z" />
  <path
     fill="none" stroke="inherit" stroke-width="1.7"
     style="stroke-linecap:round;stroke-linejoin:round"
     d="M 16.463694,10 V 26 L 7.463687,18 Z" />
  </symbol>

  <symbol id="event-compensation-throwing" viewBox="0 0 36 36" overflow="visible">
  <path
     fill="inherit" stroke="inherit" stroke-width="1.7"
     style="stroke-linecap:round;stroke-linejoin:round"
     d="m 25.463694,10 v 16 l -9,-8 z" />
  ...
  <symbol id="event-conditional-catching" viewBox="0 0 36 36" overflow="visible">
  <path
     fill="none" stroke="inherit" stroke-width="1.7"
     style="stroke-linecap:round;stroke-linejoin:round"
     d="M 11,10 H 25 V 26 H 11 Z" />
  <path
     fill="none" stroke="inherit" stroke-width="1.7"
     style="stroke-linecap:round;stroke-linejoin:round"
     d="m 14,14 h 8" />
  ...
  <symbol id="event-link-catching" viewBox="0 0 36 36" overflow="visible">
  <path
     fill="none" stroke="inherit" stroke-width="1.7"
     style="stroke-linecap:round;stroke-linejoin:round"
     d="m 22,9 6,9 -6,9 V 23 H 9 V 13 h 13 z" />
  </symbol>

  <symbol id="event-link-throwing" viewBox="0 0 36 36" overflow="visible">
  <path
     fill="inherit" stroke="inherit" stroke-width="1.7"
     style="stroke-linecap:round;stroke-linejoin:round"
     d="m 22,9 6,9 -6,9 V 23 H 9 V 13 h 13 z" />
  ...
  <symbol id="event-signal-catching" viewBox="0 0 36 36" overflow="visible">
  <path
     fill="none" stroke="inherit" stroke-width="1.7"
     style="stroke-linecap:round;stroke-linejoin:round"
     d="m 18,8 9,15 H 9 Z" />
  ...
  <symbol id="event-signal-throwing" viewBox="0 0 36 36" overflow="visible">
  <path
     fill="inherit" stroke="inherit" stroke-width="1.7"
     style="stroke-linecap:round;stroke-linejoin:round"
     d="m 18,8 9,15 H 9 Z" />
  ...
  <symbol id="event-termination-throwing" viewBox="0 0 36 36" overflow="visible">
  <circle
     fill="inherit" stroke="inherit" stroke-width="1.7"
     style="stroke-linecap:round;stroke-linejoin:round"
     cx="18"
  ...
  <symbol id="event-multiple-catching" viewBox="0 0 36 36" overflow="visible">
  <path
     fill="none" stroke="inherit" stroke-width="1.7"
     style="stroke-linecap:round;stroke-linejoin:round"
     d="m 18,8 9,7 -3,11 H 12 L 9,15 Z" />
  </symbol>

  <symbol id="event-multiple-throwing" viewBox="0 0 36 36" overflow="visible">
  <path
     fill="inherit" stroke="inherit" stroke-width="1.7"
     style="stroke-linecap:round;stroke-linejoin:round"
     d="m 18,8 9,7 -3,11 H 12 L 9,15 Z" />
  ...
  <symbol id="event-multiple-parallel-catching" viewBox="0 0 36 36" overflow="visible">
  <path
     fill="none" stroke="inherit" stroke-width="1.7"
     style="stroke-linecap:round;stroke-linejoin:round"
     d="m 15.5,8 h 5 v 7.5 H 28 v 5 H 20.5 V 28 h -5 V 20.5 H 8 v -5 h 7.5 z" />
  </symbol>

  <symbol id="event-multiple-parallel-throwing" viewBox="0 0 36 36" overflow="visible">
  <path
     fill="inherit" stroke="inherit" stroke-width="1.7"
     style="stroke-linecap:round;stroke-linejoin:round"
     d="m 15.5,8 h 5 v 7.5 H 28 v 5 H 20.5 V 28 h -5 V 20.5 H 8 v -5 h 7.5 z" />
  ...
  <symbol id="event-solid-solid" viewBox="0 0 36 36" overflow="visible">
  <circle
     style="fill:inherit;stroke:inherit;stroke-width:{STROKE_WIDTH};stroke-linecap:round;stroke-linejoin:round"
     cx="18" cy="18" r="18" />
  <circle
  ...
  <symbol id="event-dashed" viewBox="0 0 36 36" overflow="visible">
  <circle
  ...
  <symbol id="event-dashed-dashed" viewBox="0 0 36 36" overflow="visible">
  <circle
     style="fill:inherit;stroke:inherit;stroke-width:{STROKE_WIDTH};stroke-linecap:round;stroke-linejoin:round;stroke-dasharray:6.8,5.8;stroke-dashoffset:0"
     cx="18"
     cy="18"
     r="18" />
  <circle
     style="fill:inherit;stroke:inherit;stroke-width:{STROKE_WIDTH};stroke-linecap:round;stroke-linejoin:round;stroke-dasharray:5.2,4.8;stroke-dashoffset:0"
     cx="18"
     cy="18"
     r="14.3" />
  </symbol>

  <symbol id="event-thick" viewBox="0 0 36 36" overflow="visible">
  <circle
     style="fill:inherit;stroke:inherit;stroke-width:4.6;stroke-linecap:round;stroke-linejoin:round"
     cx="18" cy="18" r="16.7" />
  </symbol>
  ...
  <path
     ...
     d="M 50,8.8 C 50,11.5614237 38.807119,13.8 25,13.8 11.192881,13.8 0,11.5614237 0,8.8" />
  <path
     style="fill:none;stroke:inherit;stroke-linecap:square"
     d="M 50,12.6 C 50,15.361424 38.807119,17.6 25,17.6 11.192881,17.6 0,15.361424 0,12.6" />
  </symbol>
</defs>"##,
    )
}
